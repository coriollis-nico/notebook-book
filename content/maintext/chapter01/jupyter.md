...
### Crea el ambiente de trabajo con conda e instala el _software_ que necesites.
...
```shell
(notebook) nch@localhost-live:~$ conda install python=3.14 numpy=2.5 matplotlib=3.11 jupyterlab=4.6
```
...
Este no es un tutorial de conda.
